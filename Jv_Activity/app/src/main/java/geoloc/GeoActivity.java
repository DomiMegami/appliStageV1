...
import dominique.fr.jv_activity.BuildConfig;
...
public class GeoActivity extends AppCompatActivity {
    ...
    /**
     * Receiver registered with this activity to get the response from arles.bge.gridview.geoloc.FetchAddressIntentService.
     */
    ...
    private void updateValuesFromBundle(Bundle savedInstanceState) {
        if (savedInstanceState != null) {
            ...
            if (savedInstanceState.keySet().contains(LOCATION_ADDRESS_KEY)) {
                ...
                Log.e("adresse","adresse " + mAddressOutput);
    ...
    private void displayAddressOutput() {
        ...
        article = (Article) intent.getSerializableExtra("ARTICLE2");

        String adr_geolocalisee = mAddressOutput;

        intent = new Intent(GeoActivity.this,MapsActivity.class);
        intent.putExtra("ARTICLE",article);
        intent.putExtra("adr_geolocalisee", adr_geolocalisee);
    ...
    private void updateUIWidgets() {
        if (mAddressRequested) {
            ...
            mFetchAddressButton.setVisibility(Button.GONE);
        } else {
    ...
    /**
     * Receiver for data sent from arles.bge.gridview.geoloc.FetchAddressIntentService.
     */
    private class AddressResultReceiver extends ResultReceiver {
        ...
        /**
         *  Receives data sent from arles.bge.gridview.geoloc.FetchAddressIntentService and updates the UI in arles.bge.gridview.geoloc.GeoActivity.
         */
        @Override
       ...
       // Log.i(TAG, "onRequestPermissionResult");
        if (requestCode == REQUEST_PERMISSIONS_REQUEST_CODE) {
            if (grantResults.length <= 0) {
                ...
                Intent intent = getIntent();
                article = (Article) intent.getSerializableExtra("ARTICLE2");
                Intent intent2 = new Intent(GeoActivity.this, MapsActivity.class);
                intent2.putExtra("ARTICLE",article);
                intent2.putExtra("adr_geolocalisee", "16, rue de l'Hôtel de Ville Albi");
